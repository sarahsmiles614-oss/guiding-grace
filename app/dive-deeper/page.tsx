                    ...
                    <div className="space-y-7">
                      <div>
                        ...
                        <textarea
                          ...
                          rows={4}
                          className="w-full bg-transparent border-b border-white/20 rounded-none px-4 py-3 text-white placeholder-white/35 text-sm resize-none focus:outline-none focus:border-white/50 leading-relaxed"
                        />
                      </div>
            ...
            {activeTab === "reflections" && (
              <div>
                ...
                <textarea
                  ...
                  rows={16}
                  className="w-full bg-transparent border-b border-white/20 rounded-none px-4 py-3 text-white placeholder-white/35 text-sm resize-none focus:outline-none focus:border-white/50 leading-relaxed mb-4"
                />
                <button
