                    ...
                    <>
                      ...
                      {showHowItWorks && (
                        <div className="bg-black/70 border border-white/15 rounded-xl px-4 py-3 mb-2 space-y-2">
                          ...
                          <p className="text-white/90 text-xs leading-relaxed">3. <span className="text-white font-semibold">Jump to any day</span> — in the reading view, tap the "Day X ▾" heading at the top to type any day number (1–365) and go there instantly.</p>
                          <p className="text-white/90 text-xs leading-relaxed">4. <span className="text-white font-semibold">Listen hands-free</span> — tap the <span className="text-white">▶ Audio</span> pill in the bottom-right corner to open the audio player. It stays fixed on screen so you can pause or skip without scrolling. Close it with ✕ if you just want to read.</p>
                          <p className="text-white/90 text-xs leading-relaxed">5. <span className="text-white font-semibold">Mark as Read</span> — tap the button when done. Your progress and streak are saved automatically to your account.</p>
                          <p className="text-white/90 text-xs leading-relaxed">6. <span className="text-white font-semibold">Save a verse</span> — tap ✍️ on any verse to add a note and send it straight to your Journal.</p>
                          <p className="text-white/90 text-xs leading-relaxed">7. <span className="text-white font-semibold">Your Journal</span> — everything you save goes to Dive Deeper. View saved verses, write reflections, and share highlights.</p>
                          <p className="text-white/90 text-xs leading-relaxed">8. <span className="text-white font-semibold">No screen timeout</span> — while reading, your screen stays awake so it won't go dark mid-passage.</p>
