      ...
      <div className="min-h-screen bg-black/55 flex flex-col">
        ...
        <main className="flex-1 flex flex-col items-center px-6 py-10 max-w-2xl mx-auto w-full">
            ...
            <>
              ...
              <div className="w-full mb-8">
                <p className="text-white/90 text-sm leading-relaxed" style={{ textShadow: "0 1px 4px rgba(0,0,0,0.8)" }}>
                  {devotion.reflection.split(" ").slice(0, 30).join(" ")}...
                </p>
              </div>

              <div className="w-full bg-white/5 border border-white/10 rounded-2xl p-5 mb-10 text-center">
                <p className="text-white/40 text-xs uppercase tracking-widest mb-2">Want to read the full reflection?</p>
                <p className="text-white/70 text-sm mb-4">Sign in to access the complete devotion, study guide, grace challenge, and 10 more features.</p>
                <Link href="/subscribe">
                  <button className="bg-white/20 hover:bg-white/30 border border-white/30 text-white font-semibold py-3 px-8 rounded-2xl transition text-sm mb-2 w-full">
          ...
          <div className="w-full border-t border-white/10 pt-8">
            <p className="text-white/40 text-xs text-center mb-6">More from Guiding Grace</p>
            <div className="grid grid-cols-3 gap-4 text-center">
              {[
                { icon: "📖", label: "Daily Devotions" },
                { icon: "💛", label: "Grace Challenge" },
                { icon: "🎧", label: "Bible in 365 Days" },
