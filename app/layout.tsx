  ...
  return (
    <html lang="en">
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Libre+Baskerville:ital,wght@0,400;0,700;1,400;1,700&family=Agbalumo&family=Dancing+Script:wght@600&family=Cinzel:wght@400;600&family=Cormorant+Garamond:ital,wght@0,400;1,400;1,600&family=Josefin+Sans:wght@300;400&family=Pinyon+Script&family=EB+Garamond:ital,wght@0,400;1,400;1,600&family=Italiana&family=Great+Vibes&family=Tangerine:wght@400;700&family=Sacramento&family=Crimson+Text:ital,wght@0,400;1,400&family=Merriweather:ital,wght@0,400;1,400&family=Raleway:wght@300;400&family=Yeseva+One&family=Spectral:ital,wght@0,400;1,400&family=Fondamento:ital@0;1&family=Lato:wght@300;400&family=Philosopher:ital,wght@0,400;1,400&family=Sorts+Mill+Goudy:ital@0;1&family=Satisfy&family=IM+Fell+English:ital@0;1&family=Quicksand:wght@400;500&family=Petit+Formal+Script&family=Cinzel+Decorative:wght@400;700&family=Pacifico&display=swap" rel="stylesheet" />
